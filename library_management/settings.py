...
# ✅ Updated Database Configuration (MySQL)
DATABASES = {
    'default': {
...
# ✅ Authentication settings to allow email login
AUTH_USER_MODEL = 'library.AdminUser'
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',
]

# ✅ REST Framework Configuration (Allows Public Access to Some APIs)
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # ✅ Allow public access to some APIs
    ],
}
...
# ✅ CSRF Configuration (For API authentication)
